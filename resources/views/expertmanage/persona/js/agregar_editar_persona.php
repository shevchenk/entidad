...
$(document).ready(function() {
   ...
   /* AjaxAgregar_Editar_Persona.Cargar(HTMLCargarPersona);
    $("#PersonaForm #TablePersona select").change(function(){ AjaxAgregar_Editar_Persona.Cargar(HTMLCargarPersona); });
    $("#PersonaForm #TablePersona input").blur(function(){ AjaxAgregar_Editar_Persona.Cargar(HTMLCargarPersona); });*/
