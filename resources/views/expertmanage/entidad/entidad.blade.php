...
@section('include')
    ...
    @include( 'expertmanage.entidad.js.entidad_ajax' )
    @include( 'expertmanage.entidad.js.entidad' )
            ...
            <div class="box">
                <form id="EntidadForm">
                    <div class="box-body table-responsive no-padding">
                        <table id="TableEntidad" class="table table-bordered table-hover">
                            <thead>
                                <tr class="cabecera">
                                    <th class="col-xs-2">
                                    ...
                                    <th class="col-xs-2">
                                        <div class="form-group">
                                            <label><h4>Entidad:</h4></label>
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fa fa-search"></i></div>
                                                <input type="text" class="form-control" name="txt_entidad" id="
                                                txt_entidad" placeholder="Buscar Entidad" onkeypress="return masterG.enterGlobal(event,'.input-group',1);">
                                            </div>
                                        </div>
                                    </th>
...
@section('form')
     @include( 'expertmanage.entidad.form.entidad' )
